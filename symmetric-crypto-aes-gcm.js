...
// GCM’s security is dependent on choosing a unique initialization vector for each encryption. Do not hard code this!
// Use this method if you want to encrypt the payload and verify the sender.
// The key, initialization vector and auth tag must be shared between both sender and receiver.
...
var algorithm = 'aes-256-gcm';                  // Cypher algorithm
